...
void QMLSettings::setupKeys() {
    ...
    addKey(QString("setBlockrow1"),QString("seed/Blockrow1"),"double");
    addKey(QString("setBlockrow2"),QString("seed/Blockrow2"),"double");
    addKey(QString("setBlockrow3"),QString("seed/Blockrow3"),"double");
    addKey(QString("setBlockrow4"),QString("seed/Blockrow4"),"double");
    addKey(QString("setBlockrow5"),QString("seed/Blockrow5"),"double");
    addKey(QString("setBlockrow6"),QString("seed/Blockrow6"),"double");
    addKey(QString("setBlockrow7"),QString("seed/Blockrow7"),"double");
    addKey(QString("setBlockrow8"),QString("seed/Blockrow8"),"double");
    addKey(QString("setBlockrow9"),QString("seed/Blockrow9"),"double");
    addKey(QString("setBlockrow10"),QString("seed/Blockrow10"),"double");
    addKey(QString("setBlockrow11"),QString("seed/Blockrow11"),"double");
    addKey(QString("setBlockrow12"),QString("seed/Blockrow12"),"double");
    addKey(QString("setBlockrow13"),QString("seed/Blockrow13"),"double");
    addKey(QString("setBlockrow14"),QString("seed/Blockrow14"),"double");
    addKey(QString("setBlockrow15"),QString("seed/Blockrow15"),"double");
    addKey(QString("setBlockrow16"),QString("seed/Blockrow16"),"double");
    addKey(QString("SeedernumRows"),QString("seed/SeedernumRows"),"double");
    addKey(QString("setBlockcountMin"),QString("seed/BlockcountMin"),"double");
    addKey(QString("setBlockcountMax"),QString("seed/BlockcountMax"),"double");
    addKey(QString("setModule_defaultRows"),QString("seed/ModuledefaultRows"),"double");
